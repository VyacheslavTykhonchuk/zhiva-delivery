(function ($) {
    ...
    window.zhiva = $.extend({}, {
        ...
        init() {
            ...
            zhiva.initMobileCatFilters();
        },
        initMobileCatFilters() {
            if (!$('.mobileCategoryControls').length) return false;
            let filtersWrap = $('.mobileCategoryControls'),
                openFilters = $('.toggleCategoryFiltersMobile'),
                openSubCat = $('.toggleSubCategoryMobile');
            openFilters.on('click', function () {
                filtersWrap.toggleClass('filtersOpened');
                filtersWrap.removeClass('subCatOpened');
            });
            openSubCat.on('click', function () {
                filtersWrap.toggleClass('subCatOpened');
                filtersWrap.removeClass('filtersOpened');
            });
        },
        initMobileMenu() {
            let mobileMenu = $('#mobileMainMenu'),
                ...
                openMenuItem = mobileMenu.find('.main-menu-mobile__item:not(.main-menu-mobile__item_main-menu)');
            ...
            openMenuItem.each(function () {
                $(this).on('click', function () {
                    ...
                    $(this).siblings().find('.mobile-item-dropdown__item').removeClass('itemAnimation');

                    $(this).find('.mobile-item-dropdown__item').each(function (i) {
                        let $el = $(this);
                        setTimeout(function () {
                            $el.toggleClass('itemAnimation');
                        }, i * 50);
                    });
                });
            });
        ...
        initHeaderBucket() {
            ...
            // productMainBuy();
            // function productMainBuy() {
            //     let mainBuy = $('.productMainBuy'),
            //         itemPrice = mainBuy.find('.productPrice').attr('data-product-price'),
            //         buy = $('.block-buy__submit');
